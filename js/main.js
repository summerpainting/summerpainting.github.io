...
scrollToTopBtn.style.transition = 'opacity var(--transition-normal)';
...
galleryItems.forEach(item => {
    item.addEventListener('click', function() {
        const imgPlaceholder = this.querySelector('.gallery-img');
        // 在实际应用中，这里应该设置真实图片的URL
        // viewerContent.src = imgPlaceholder.dataset.imgUrl;
    ...
    galleryItems.forEach(item => {
        ...
        if (detailsBtn) {
            detailsBtn.addEventListener('click', function(e) {
                ...
                // 可以在这里添加查看详情的逻辑
                alert('查看作品详情: ' + imgPlaceholder.dataset.imgId);
            });
        }
    });
